import { computed, ref, useAttrs, useTemplateRef, mergeProps, useSSRContext, defineComponent, createElementBlock, shallowRef, getCurrentInstance, provide, cloneVNode, h } from 'vue';
import { ssrRenderAttrs, ssrRenderSlot } from 'vue/server-renderer';
import { x as defu, y as withLeadingSlash, k as hasProtocol, m as joinURL, z as parseURL, A as encodeParam, B as encodePath } from '../nitro/nitro.mjs';
...
const ipxRuntime$GSYUuZjOqNqtVSVweRP1I_45DojBMSbGEWoY1DBy4265w = defineProvider({
...
const imageOptions = {
  ...
  provider: "ipx",
  providers: {
    ["ipx"]: { setup: ipxRuntime$GSYUuZjOqNqtVSVweRP1I_45DojBMSbGEWoY1DBy4265w, defaults: {} }
  }
};
